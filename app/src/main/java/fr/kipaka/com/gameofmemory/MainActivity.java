...
class MainActivity extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
          ...
          //  case R.id.a_propos:
           //     msg1 = getString(R.string.a_propos);
             //   break;
        }

        Toast.makeText(this, msg + " clicked !", Toast.LENGTH_SHORT).show();
      //  Toast.makeText(this, msg1 + "Dévelopeur KIPAKA Mubwala AND TALEB Nassim!", Toast.LENGTH_SHORT).show();

        int id = item.getItemId();
        if (id == R.id.action_second_activity) { // si Id va dans la second activity
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                ...
                .setUrl(Uri.parse("http://heritier.kipaka;free.fr"))
                .build();
